...
\begin{frame}{}
  \begin{table}[h]
    \centering
    \caption{Atomicity~\footnote{也称 Linearizability} 相关一致性模型验证问题复杂度 {\small (假设: 不允许写重复值)}}
    \renewcommand\arraystretch{1.1}
    \resizebox{\textwidth}{!}{
...
\begin{frame}{}
  ...
  \vspace{0.50cm}
  \fignocaption{width = 0.55\textwidth}{figs/atomicity-example}
\end{frame}
%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%
\begin{frame}{}
  % \begin{cdef}[$k$-Atomicity \ncite{Aiyer:DISC05} \ncite{Taubenfeld:ICDCN13}]
  \begin{center}
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  % \begin{cdef}[$\mathcal{I}$-Atomicity]
  \begin{center}
