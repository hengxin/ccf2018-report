...
\begin{frame}{}
  \begin{columns}
	...
	{\small (单线程; 顺序语义)}
      ...
      \vspace{0.20cm}
      \fignocaption{frame, width = 0.45\textwidth}{figs/alg-ds-wirth}
    \pause
    \column{0.50\textwidth}
      \begin{center}
	...
	{\small (多线程; 并发语义)}
      ...
      \vspace{0.50cm}
      \fignocaption{frame, width = 0.50\textwidth}{figs/taomp-herlihy}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{center}
	...
	\item<3-> \fcolorbox{yellow}{yellow!60}{副本 \term{replication}}: 就近访问, 容灾备份
      \end{enumerate}
    \end{minipage}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
	...
	\item \fcolorbox{yellow}{yellow!60}{Read/Write Register}
	\item Counter
	\item Set
	\item \fcolorbox{yellow}{yellow!60}{List}
	\item Hash Map
	\item Disjoint Set
	\item Graph
      \end{itemize}
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fignocaption{width = 0.75\textwidth}{figs/rdt-research}
\end{frame}
%%%%%%%%%%%%%%%
